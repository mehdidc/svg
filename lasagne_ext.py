...
from lasagne.base import MergeLayer, Layer
...
class LSTMLayer(MergeLayer):
    ...
    def __init__(self, incoming, num_units,
        ...
        (self.W_hid_to_forgetgate, self.b_forgetgate,
        ...
        (self.W_hid_to_outgate, self.b_outgate,
    ...
    def get_output_shape_for(self, input_shapes):
        ...
        return input_shape[0], self.n_steps, self.num_units
    ...
    def get_output_for(self, inputs, **kwargs):
        ...
        elif isinstance(self.hid_init, Layer):
            hid_init = helper.get_output(self.hid_init, input)
        else:
            # Dot against a 1s vector to repeat to shape (num_batch, num_units)
